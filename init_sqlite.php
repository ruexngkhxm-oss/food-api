...
(1, 3, 2, 'ผัดไทยกุ้งสด', 'ผัดไทยสูตรต้นตำรับ เส้นนุ่มเหนียวกำลังดี รสเปรี้ยวหวานเค็มลงตัว ใส่กุ้งสดตัวโตให้ความหวานธรรมชาติ', 'https://images.unsplash.com/photo-1559314809-0d155014e29e?w=1200&q=80', 30, 2, 1),
(2, 3, 1, 'ต้มยำกุ้ง', 'ต้มยำกุ้งน้ำข้น รสจัดจ้าน เปรี้ยวเผ็ดเค็มหวานครบรส หอมเครื่องต้มยำสมุนไพรไทย', 'https://images.unsplash.com/photo-1548943487-a2e4e43b4853?w=1200&q=80', 25, 3, 1),
(3, 3, 3, 'แกงเขียวหวานไก่', 'แกงเขียวหวานสูตรเข้มข้น หอมกะทิ เผ็ดกำลังดี ใส่มะเขือเปราะและใบโหระพาหอมสดชื่น', 'https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?w=1200&q=80', 40, 4, 0),
(4, 3, 7, 'ข้าวผัดไข่', 'เมนูง่ายๆ ทำได้ไวใน 15 นาที ข้าวสวยหอมผัดกับไข่เยิ้มๆ เหมาะเป็นมื้อด่วนสำหรับทุกวัน', 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=1200&q=80', 15, 1, 1),
(5, 3, 2, 'หมูกระเทียมพริกไทย', 'หมูสไลซ์นุ่มๆ ผัดกับกระเทียมเจียวหอมกรอบและพริกไทยสด กินคู่ข้าวสวยร้อนๆ อร่อยเข้ากันสุดๆ', 'https://images.unsplash.com/photo-1544025162-d76694265947?w=1200&q=80', 20, 2, 0);
");
...
(2, 1, 3, 1, NULL, 'ขอบคุณมากๆ เลยครับ ลองทำทานดูแล้วติชมได้เสมอนะครับ'),
(3, 2, 2, NULL, 5, 'ต้มยำกุ้งรสชาติต้นตำรับ เผ็ดแซ่บสะใจมากครับ!'),
(4, 2, 3, NULL, 5, 'เชฟเตวรากรหมู่ 6 คอนเฟิร์มว่าน้ำซุปต้มยำสูตรนี้กลมกล่อมสมุนไพรลงตัวมากครับ');
");
